...
export default function Ingenious() {
  return (
    <main className="flex h-[100dvh] w-full flex-col items-center justify-center bg-white text-black">
      <div className="space-y-5 w-full px-[5%] md:w-[60%] mx-auto text-center"><h1 className="text-2xl md:text-3xl font-semibold">Discover. Inspire. Activate. Nurture. Accelerate.</h1>
      <p>
        Ingenious is a 1-Year program we are designing to discover, inspire, activate, nurture, and accelerate early tech talent and founders to build the next generation of world-class tech companies that will drive impact on the African continent.
      </p>
      <p>
